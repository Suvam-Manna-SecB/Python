//Write a Menu driven C program to accomplish the following functionalities in 
...
c. Return the value of the FRONT element of the queue (without deleting it from    
    the queue) using an array (Peep operation). 
